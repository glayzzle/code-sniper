 ...
 */
Session.prototype.clear = function(filename) {
 ...
 */
Session.prototype.set = function(filename, key, value) {
  if (!(filename in this.data)) {
    this.data[filename] = {};
  }
  if (!(key in this.keys)) {
 ...
 */
Session.prototype.getValue = function(filename, key) {
 ...
 */
Session.prototype.getValues = function(key) {
  var result = [];
  if (key in this.keys) {
